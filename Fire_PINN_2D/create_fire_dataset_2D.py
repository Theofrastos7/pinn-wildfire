...
def create_fire_dataset():
    ...
    - y: spatial array
    - t: time array
    - T_sol: temperature solution array
    - F_sol: fuel solution array
    ...
    T_sol,F_sol=Diffusion_Reaction_Windless_Operator_Splitting(1,w1,w2,1,1,lamb,beta,0,Nx_int,Ny_int,dx,dy,dt,T_total,start_x_int, start_y_int, end_x_int, end_y_int,temp1,temp2,fuel1,fuel2)
    ...
    # Return parameters and solution
    params = {
        'Ta': Ta,
        'lamb': lamb,
        'beta': beta,
...
def save_to_single_csv(x, y, t, T_sol, F_sol, params, prefix="fire_dataset"):
    ...
    - Columns: x, y, t, T, F, Ta, lamb, beta, w1, w2
    """

    # Create data directory if it doesn't exist
    os.makedirs("Fire_PINN_2D/data", exist_ok=True)
    ...
    print(f"    w1={params['w1']}, w2={params['w2']}")
    print(f"\nFirst 10 rows:")
