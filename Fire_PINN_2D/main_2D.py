...
print(f"For temperature: {(1/B):.5f}")



T1,F1=Diffusion_Reaction_Windless_Operator_Splitting(1,w1,w2,1,1,lamb,beta,0,Nx_int,Ny_int,dx,dy,dt,T_total,start_x_int, start_y_int, end_x_int, end_y_int,temp1,temp2,0.45,0.55)
...
plt.tight_layout()
plt.savefig('Fire_PINN_2D/graphs/snapshots.png', dpi=150, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('Fire_PINN_2D/graphs/temperature_3d_snapshots.png', dpi=150, bbox_inches='tight')
plt.show()
