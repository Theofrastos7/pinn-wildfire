...
def Diffusion_Reaction_Windless_Operator_Splitting(k, w1_q1, w2_q1, w1_q4, w2_q4, w1_q3, w2_q3, w1_q2, w2_q2,
                                                   A, B, C, CS, Ta, Nx, Ny, dx, dy, dt, T_total,
                                                   area_start_x, area_start_y, area_size_x, area_size_y, temp1, temp2, fuel1, fuel2):
    """
    4 quadrants with different w parameters (diffusion weights)
    Q1 is top-right, where: x >= mid_x, y >= mid_y = w1_q1, w2_q1
    Q2 is top-left, where:  x < mid_x,  y >= mid_y = w1_q2, w2_q2
    Q3 is bottom-left, where: x < mid_x,  y < mid_y  = w1_q3, w2_q3
    Q4 is bottom-right, where: x >= mid_x, y < mid_y  = w1_q4, w2_q4
    """
