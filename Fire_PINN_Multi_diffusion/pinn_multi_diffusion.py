...
class FirePINN():
    def __init__(self, X_data, TF_data, X_collocation, X_ic, TF_ic, layers, lb, ub, fire_params):
        ...
        lb, ub: domain bounds
        fire_params: dict with Ta, lamb, beta, w1_q1, w2_q1, w1_q2, w2_q2, w1_q3, w2_q3, w1_q4, w2_q4
        """
        # Domain bounds
        ...
        # W parameters for each quadrant
        self.w1_q1 = fire_params['w1_q1']  # top-right
        self.w2_q1 = fire_params['w2_q1']
        self.w1_q2 = fire_params['w1_q2']  # top-left
        self.w2_q2 = fire_params['w2_q2']
        self.w1_q3 = fire_params['w1_q3']  # bottom-left
        self.w2_q3 = fire_params['w2_q3']
        self.w1_q4 = fire_params['w1_q4']  # bottom-right
    ...
    def net_pde(self, x, y, t):
        ...
        # Determine position for each collocation point in order to use correct w1 and w2
...
print(f"Q1: w1={w1_q1}, w2={w2_q1}")
print(f"Q2: w1={w1_q2}, w2={w2_q2}")
print(f"Q3: w1={w1_q3}, w2={w2_q3}")
print(f"Q4: w1={w1_q4}, w2={w2_q4}")
print(f"Ta={Ta}")
...
plt.tight_layout()
plt.savefig('Fire_PINN_Multi_diffusion/graphs/fire_pinn_2d_snapshots.png', dpi=150, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Fire_PINN_Multi_diffusion/graphs/fire_pinn_2d_error_snapshots.png', dpi=150, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Fire_PINN_Multi_diffusion/graphs/fire_pinn_lbfgs_loss_history.png', dpi=150, bbox_inches='tight')
print("Loss history saved to 'fire_pinn_lbfgs_loss_history.png'")

# Save model
torch.save(model.dnn.state_dict(), 'Fire_PINN_Multi_diffusion/data/fire_pinn_lbfgs_model.pth')
print("Model saved to 'Fire_PINN_Multi_diffusion/data/fire_pinn_lbfgs_model.pth'")
