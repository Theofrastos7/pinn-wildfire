...
class FirePINN():
    ...
    def net_pde(self, x, y, t):
        ...
        # Determine position for each collocation point in order to use correct lamb and beta
...
plt.tight_layout()
plt.savefig('Fire_PINN_Multi_variable/graphs/fire_pinn_2d_snapshots.png', dpi=150, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Fire_PINN_Multi_variable/graphs/fire_pinn_2d_error_snapshots.png', dpi=150, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Fire_PINN_Multi_variable/graphs/fire_pinn_lbfgs_loss_history.png', dpi=150, bbox_inches='tight')
print("Loss history saved to 'fire_pinn_lbfgs_loss_history.png'")

# Save model
torch.save(model.dnn.state_dict(), 'Fire_PINN_Multi_variable/data/fire_pinn_lbfgs_model.pth')
print("Model saved to 'Fire_PINN_Multi_variable/data/fire_pinn_lbfgs_model.pth'")
