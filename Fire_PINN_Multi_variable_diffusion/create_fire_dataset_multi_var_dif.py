...
import pandas as pd
import numpy as np
from functions_multi_var_dif import Diffusion_Reaction_Windless_Operator_Splitting
...
def create_fire_dataset():
    ...
    (Ta, lamb1, beta1, lamb2, beta2, lamb3, beta3, lamb4, beta4, w1_q1, w2_q1, w1_q2, w2_q2, w1_q3, w2_q3, w1_q4, w2_q4)
    """
    ...
    # Define 4 quadrants with different diffusion weights
    ...
    T_sol,F_sol=Diffusion_Reaction_Windless_Operator_Splitting(1,w1_q1, w2_q1, w1_q2, w2_q2, w1_q3, w2_q3, w1_q4, w2_q4,1,1,
                                                               lamb1,beta1,lamb2,beta2,lamb3,beta3,lamb4,beta4,0,Nx_int,Ny_int,dx,dy,dt,T_total,start_x_int, start_y_int, end_x_int, end_y_int,temp1,temp2, fuel1,fuel2)
...
def save_to_single_csv(x, y, t, T_sol, F_sol, params, prefix="fire_dataset"):
    ...
    - Columns: x, y, t, T, F, Ta, w1_q1, w2_q1, w1_q2, w2_q2, w1_q3, w2_q3, w1_q4, w2_q4, lamb1, beta1, lamb2, beta2, lamb3, beta3, lamb4, beta4
    """

    # Create data directory if it doesn't exist
    os.makedirs("Fire_PINN_Multi_variable_diffusion/data", exist_ok=True)
