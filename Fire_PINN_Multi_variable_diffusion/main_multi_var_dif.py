...
from functions_multi_var_dif import *
...
T1,F1=Diffusion_Reaction_Windless_Operator_Splitting(1, w1_q1, w2_q1, w1_q2, w2_q2, w1_q3, w2_q3, w1_q4, w2_q4, 1, 1, lamb1, beta1, lamb2, beta2, lamb3, beta3, lamb4, beta4,
                                                     0, Nx_int, Ny_int, dx, dy, dt, T_total, start_x_int, start_y_int, end_x_int, end_y_int, temp1, temp2, 0.45, 0.55)

# --- Plot snapshots ---

# time snapshots considering the original t_total
time_snapshots = [20, 140, 260, 300]
...
plt.tight_layout()
plt.savefig('Fire_PINN_Multi_variable_diffusion/graphs/snapshots.png', dpi=150, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('Fire_PINN_Multi_variable_diffusion/graphs/temperature_3d_snapshots.png', dpi=150, bbox_inches='tight')
plt.show()
