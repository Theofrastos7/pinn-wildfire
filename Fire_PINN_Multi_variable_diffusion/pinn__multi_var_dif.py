...
class FirePINN():
    def __init__(self, X_data, TF_data, X_collocation, X_ic, TF_ic, layers, lb, ub, fire_params):
        ...
        lb, ub: domain bounds
        fire_params: dict with Ta, lamb1, beta1, lamb2, beta2, lamb3, beta3, lamb4, beta4, w1_q1, w2_q1, w1_q2, w2_q2, w1_q3, w2_q3, w1_q4, w2_q4
        """
        # Domain bounds
        ...
        # Fire parameters from dataset with 4 quadrants
        # Q1 top-right, Q2 top-left, Q3 bottom-left, Q4 bottom-right
        self.lamb1 = fire_params['lamb1']
        self.beta1 = fire_params['beta1']
        self.lamb2 = fire_params['lamb2']
        self.beta2 = fire_params['beta2']
        self.lamb3 = fire_params['lamb3']
        self.beta3 = fire_params['beta3']
        self.lamb4 = fire_params['lamb4']
        self.beta4 = fire_params['beta4']
        self.Ta = fire_params['Ta']
        self.w1_q1 = fire_params['w1_q1']
        self.w2_q1 = fire_params['w2_q1']
        self.w1_q2 = fire_params['w1_q2']
        self.w2_q2 = fire_params['w2_q2']
        self.w1_q3 = fire_params['w1_q3']
        self.w2_q3 = fire_params['w2_q3']
        self.w1_q4 = fire_params['w1_q4']
        self.w2_q4 = fire_params['w2_q4']
    ...
    def net_pde(self, x, y, t):
        ...
        # Determine position for each collocation point in order to use correct lamb, beta, and w
...
plt.tight_layout()
plt.savefig('Fire_PINN_Multi_variable_diffusion/graphs/fire_pinn_2d_snapshots.png', dpi=150, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Fire_PINN_Multi_variable_diffusion/graphs/fire_pinn_2d_error_snapshots.png', dpi=150, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Fire_PINN_Multi_variable_diffusion/graphs/fire_pinn_lbfgs_loss_history.png', dpi=150, bbox_inches='tight')
print("Loss history saved to 'fire_pinn_lbfgs_loss_history.png'")

# Save model
torch.save(model.dnn.state_dict(), 'Fire_PINN_Multi_variable_diffusion/data/fire_pinn_lbfgs_model.pth')
